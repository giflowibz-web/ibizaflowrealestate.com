...
const FALLBACK_IMAGE = 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1920&q=85';
...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-black">
      {/* Fondo: video si existe, imagen si no */}
      <div className="absolute inset-0 z-0">
        {/* Imagen de fallback siempre presente */}
        <img
          src={FALLBACK_IMAGE}
          alt="Ibiza"
          className="h-full w-full object-cover"
          style={{ opacity: videoLoaded ? 0 : 0.8, transition: 'opacity 0.8s ease' }}
        />
        ...
        {videoUrl && (
          <video
            ...
            style={{ opacity: videoLoaded ? 0.8 : 0, transition: 'opacity 0.8s ease' }}
          >
