          ...
          <div className="flex flex-wrap gap-8 md:gap-12">
            ...
            {property.lotSqm && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white text-xl font-bold">
                    {property.lotSqm.toLocaleString()} m&sup2;
                  </p>
                  <p className="text-white/50 text-[12px] uppercase tracking-wider">
                    Parcela
                  </p>
      ...
      <section className="bg-black py-20 md:py-32">
        <div className="max-w-[1400px] mx-auto px-[6%] text-center">
          ...
          <p className="text-white/60 text-lg font-body max-w-2xl mx-auto mb-10">
            Nuestro equipo de expertos te acompanara en una visita exclusiva a
            esta propiedad. Contactanos para agendar tu cita.
          </p>
