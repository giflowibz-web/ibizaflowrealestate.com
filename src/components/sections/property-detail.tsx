        ...
        <div style={{ borderRight: "1px solid #ebebeb" }}>
          ...
          <section id="descripcion" style={{ padding: "64px 64px 48px" }}>
            ...
            <section id="info-basica" style={{ padding: "0 64px 64px" }}>
              <div style={{ borderTop: "1px solid #ebebeb", paddingTop: 56 }}>
                    <p style={{ fontSize: "1rem", fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: "#002FA7", margin: "0 0 8px" }}>
                      Información Básica
                    </p>
          ...
          <section id="caracteristicas" style={{ padding: "0 64px 64px" }}>
            <div style={{ borderTop: "1px solid #ebebeb", paddingTop: 52 }}>
                  <p style={{ fontSize: "1rem", fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: "#002FA7", margin: "0 0 36px" }}>
                    Características y Comodidades
                  </p>
          ...
          {mapSrc && (
            <section style={{ padding: "0 64px 80px" }}>
              <div style={{ borderTop: "1px solid #ebebeb", paddingTop: 52 }}>
                  <p style={{ fontSize: "0.82rem", fontWeight: 700, letterSpacing: "0.25em", textTransform: "uppercase", color: "#002FA7", margin: "0 0 24px" }}>Ubicación</p>
      ...
      {images.length > 0 && (
        <section style={{ background: "#0A0A0A", padding: "72px 52px 80px" }}>
          <div style={{ maxWidth: 1400, margin: "0 auto" }}>
              <p style={{ fontSize: "0.82rem", fontWeight: 700, letterSpacing: "0.25em", textTransform: "uppercase", color: "#002FA7", margin: "0 0 28px" }}>Galería completa</p>
            {images[0] && (
              <div
                onClick={() => setLightboxIdx(0)}
